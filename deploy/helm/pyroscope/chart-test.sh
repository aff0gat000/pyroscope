...
assert_output    "micro: RWX"               "ReadWriteMany"   helm template test "$CHART" -f "$EXAMPLES/microservices-openshift.yaml"
assert_output    "micro: storageClass"      "nfs-client"      helm template test "$CHART" -f "$EXAMPLES/microservices-openshift.yaml"
