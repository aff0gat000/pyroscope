...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AbstractVerticle verticle = switch (function) {
            case "ReadPyroscopeProfile.sor.v1" -> new ProfileDataVerticle(pyroscopeUrl, port);
            case "ReadPyroscopeBaseline.sor.v1" -> new BaselineVerticle(port);
            case "CreatePyroscopeTriageHistory.sor.v1" -> new TriageHistoryVerticle(port);
            case "ReadPyroscopeServiceRegistry.sor.v1" -> new ServiceRegistryVerticle(port);
            case "ReadPyroscopeAlertRule.sor.v1" -> new AlertRuleVerticle(port);
            default -> {
